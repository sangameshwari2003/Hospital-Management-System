...
class Doctor:
    def __init__(self,master):
        ...
        #===========LABELS=============          
        self.lblempid = Label(self.LoginFrame,text="DOCTOR ID",font="Helvetica 14 bold",bg="cadet blue",bd=22)
        ...
        self.lblempname = Label(self.LoginFrame,text="DOCTOR NAME",font="Helvetica 14 bold",bg="cadet blue",bd=22)
        ...
        self.etype1=Label(self.LoginFrame,text="DOCTOR SPECIALISATION",font="Helvetica 14 bold",bg="cadet blue",bd=22)
...
class D_EMP:
    ...
    def DELETE_EMP(self):        
        ...
        conn.commit()   
# Create an instance of Tkinter GUI
#root = Tk()

# Create an instance of the Billing class
#doctor_window = Doctor(root)

# Start the Tkinter GUI application's main loop
#root.mainloop()
